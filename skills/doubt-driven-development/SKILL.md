...
This is not `code-review-and-quality`. That skill produces a verdict on a finished artifact. This is an in-flight posture: non-trivial decisions get cross-examined while course-correction is still cheap.
...
| "I'll do doubt at the end with `code-review-and-quality`" | That skill is a final gate. Doubt-driven catches wrong directions early when course-correction is cheap. By PR time it's too late. |
...
- **`code-review-and-quality`**: complementary. It's a post-hoc PR verdict; doubt-driven is in-flight per-decision. Use both.
