...
- **Default: a checklist-style markdown file at `tasks/todo.md`.** This is the convention `ao-autonomous-plan-execution` and other downstream tooling expect. Use it unless the project says otherwise.
